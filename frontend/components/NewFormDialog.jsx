...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, TextField, Autocomplete, Input } from '@mui/material';
            ...
            <DialogContent>
                ...
                {coursesList && (
                    <Autocomplete
                        ...
                        onChange={(event, newValue) => { setSelectedCourses(newValue) }} // Atualiza o estado dos cursos selecionados
                        renderInput={(params) => (
                            <TextField
                                {...params}
                                label="Curso"
                ...
                <p><strong>Pesquise um fluxograma diretamente da nossa base de dados.</strong></p>
                <p><strong>---------------------------------- ou ----------------------------------</strong></p>
                <Input type="file" onChange={handleFileChange} />
                <p><strong>Faça upload de um fluxograma diretamente do seu computador.</strong></p>
            </DialogContent>


            <DialogActions>
                <Button onClick={onClose}>Cancelar</Button>
                <Button onClick={handleAssemble} variant="contained" color="primary">Montar fluxograma</Button>
            </DialogActions>
        </Dialog>
    );
}
