...
**Obs:** O *Total*(pts) é calculado com base nos critérios de viabilidade (v), criticidade (c) e valor de negócio (vn) da US referida. É atribuido para cada critério valores de 1 a 3 e realizada a equação:
$$Total =  v + c + vn$$

| Número | Nome                                      | Descrição                                                                                                                                                                                            | Valor de negócio | Viabilidade | Criticidade | Total |
| :----: | ----------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------: | :---------: | :---------: | :---: |
|  US01  | Disponibilizar fluxograma padrão          | Como estudante quero ter a minha disposição o fluxograma padrão da universidade já montado, para não precisar fazer esse trabalho manualmente                                                        |        1         |      3      |      1      |   5   |
